defmodule CodeCampWeb.UserAuthTest do
  use CodeCampWeb.ConnCase, async: true

  alias CodeCamp.Accounts
  alias CodeCampWeb.UserAuth
  import CodeCamp.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, CodeCampWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      CodeCampWeb.Endpoint.subscribe(live_socket_id)
